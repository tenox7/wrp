...
* [Download a WRP binary](https://github.com/tenox7/wrp/releases/) and run it on a machine that will become your WRP gateway/server. This machine should be modern, high spec and Google Chrome / Chromium Browser is required to be preinstalled. **DO NOT RUN WRP ON YOUR OLD MACHINE!**
